...
<button id="scc-preferences-icon" class="scc-preferences-icon"
	aria-label="<?php esc_attr_e('Cookie Settings', 'simple-cookie-consent'); ?>" style="display:none"
	onclick="SimpleCookieConsent.openPreferences()">
	<svg version="1.1" id="Layer_1" width="20" height="20" fill="currentColor" aria-hidden="true"
		xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		viewBox="0 0 120.23 122.88" style="enable-background:new 0 0 120.23 122.88" xml:space="preserve">
		<style type="text/css">
			.st0 {
				fill-rule: evenodd;
				clip-rule: evenodd;
